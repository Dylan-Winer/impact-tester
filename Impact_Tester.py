...
import sys
from PyQt5.QtWidgets import QDialog, QApplication, QFileDialog, QWidget, QInputDialog, QLineEdit
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(758, 472)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.browse = QtWidgets.QPushButton(self.centralwidget)
        self.browse.setGeometry(QtCore.QRect(130, 80, 201, 51))
        self.browse.setObjectName("browse")
        self.title = QtWidgets.QLabel(self.centralwidget)
        self.title.setGeometry(QtCore.QRect(200, 10, 361, 51))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.title.sizePolicy().hasHeightForWidth())
        self.title.setSizePolicy(sizePolicy)
        self.title.setSizeIncrement(QtCore.QSize(2, 0))
        font = QtGui.QFont()
        ...
        self.label1.setGeometry(QtCore.QRect(10, 100, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label1.setFont(font)
        self.label1.setObjectName("label1")
        self.label2 = QtWidgets.QLabel(self.centralwidget)
        self.label2.setGeometry(QtCore.QRect(10, 160, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label2.setFont(font)
        self.label2.setObjectName("label2")
        self.label3 = QtWidgets.QLabel(self.centralwidget)
        self.label3.setGeometry(QtCore.QRect(280, 160, 151, 21))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label3.setFont(font)
        self.label3.setObjectName("label3")
        self.height = QtWidgets.QLineEdit(self.centralwidget)
        self.height.setGeometry(QtCore.QRect(170, 160, 71, 21))
        self.height.setObjectName("height")
        self.output = QtWidgets.QLabel(self.centralwidget)
        self.output.setGeometry(QtCore.QRect(320, 240, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.output.setFont(font)
        self.output.setObjectName("output")
        self.mass = QtWidgets.QLineEdit(self.centralwidget)
        self.mass.setGeometry(QtCore.QRect(450, 160, 71, 21))
        self.mass.setObjectName("mass")
        self.final_2 = QtWidgets.QPushButton(self.centralwidget)
        self.final_2.setGeometry(QtCore.QRect(580, 160, 151, 32))
        self.final_2.setObjectName("final_2")
        self.label4 = QtWidgets.QLabel(self.centralwidget)
        self.label4.setGeometry(QtCore.QRect(360, 100, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.label4.setFont(font)
        self.label4.setObjectName("label4")
        self.label5 = QtWidgets.QLabel(self.centralwidget)
        self.label5.setGeometry(QtCore.QRect(420, 100, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(18)

        self.n = QtWidgets.QLabel(self.centralwidget)
        self.n.setGeometry(QtCore.QRect(230, 280, 350, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.n.setFont(font)
        self.n.setObjectName("label1")

        self.force = QtWidgets.QLabel(self.centralwidget)
        self.force.setGeometry(QtCore.QRect(230, 310, 350, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.camera.setGeometry(QtCore.QRect(550, 80, 201, 51))
    ...
    def ballTracker3(self):
        ...
        Energy = m * g * h
        print("Potential Energy in Joules: ", round(Energy, 4))
        text = "Potential Energy in Joules: " + str(Energy)
        self.n.setText(text)
        ...
        def x_y_graph():
            ...
            # giving acombin title to my graph
            plt.title('Y Position (feet) of Weight vs X Position (feet)')
        ...
        def y_time_graph():
            ...
            all_y2 = []
            for y_val in all_y:
                new_y = dimensions[0] - y_val
                all_y2.append(new_y)
            y = all_y2  # y positions of center of weight
        ...
        force = mass * 2*g * height
        print("Impact force in Newtons:", force)
        text2 = "Impact force in Newtons: " + str(force)
        self.force.setText(text2)
